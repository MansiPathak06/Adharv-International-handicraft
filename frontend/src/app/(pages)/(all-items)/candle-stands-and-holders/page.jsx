...
const CandleStandsHolders = () => {
 ...
 // ✅ FIXED: Fetch Candle Stands and Holders from backend
useEffect(() => {
  async function fetchProducts() {
    ...
    try {
      ...
      // ✅ Find Candle Stand products with case-insensitive matching
      const candleStandProducts = allProducts.filter((prod) => {
      ...
      console.log(`✅ Total Candle Stand products found: ${candleStandProducts.length}`);
      
      setProducts(candleStandProducts);
    } catch (error) {
  ...
  // Filter and Sort (no subcategory filtering)
  const filteredProducts = products
    ...
    .sort((a, b) => {
      ...
      return (b.reviews || 0) - (a.reviews || 0); // best-selling default
    });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-50">
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(https://i.pinimg.com/736x/e5/83/fa/e583fa967dea1c4b972aeb8228d292b3.jpg)',
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="container mx-auto px-6 lg:px-16">
            <div className="max-w-2xl text-white space-y-4">
              <h1 className="text-5xl lg:text-6xl font-bold">Candle Stands and Holders</h1>
              <p className="text-xl text-amber-100">
                Create a Soft Glow with Elegant Candle Accents
              </p>
              <p className="text-lg text-amber-200">
                Designed to Add Warmth and Charm to Any Space
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-6 lg:px-16 py-12">
        ...
        <div className="text-sm text-gray-600 mb-8">
          Home / Products / <span className="text-amber-700 font-medium">Candle Stands and Holders</span>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-6">
              ...
              <div className="bg-gradient-to-br from-amber-100 to-orange-100 rounded-xl p-4 border-2 border-amber-300">
                ...
                <p className="text-xs text-amber-800">
                  Get up to 40% off on selected candle stands
                </p>
              </div>
            </div>
          </aside>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {loading ? (
                <div className="col-span-full text-center text-lg py-8 text-amber-600">
                  Loading candle stands and holders...
                </div>
      ...
      <div className="bg-white py-12 mt-16">
        <div className="container mx-auto px-6 lg:px-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              { icon: '✓', title: 'Premium Quality', desc: 'Elegant Brass Designs' },
...
export default CandleStandsHolders;
