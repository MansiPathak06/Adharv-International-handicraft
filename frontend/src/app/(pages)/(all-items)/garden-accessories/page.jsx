...
const GardenAccessories = () => {
  ...
  // Fetch only Garden Accessories from backend
  useEffect(() => {
      ...
      try {
        ...
        setProducts(
          (data.products || []).filter(
            (prod) =>
              (prod.category || "").toLowerCase() === "garden accessories"
          )
        );
      } finally {
        setLoading(false);
  ...
  const filteredProducts = products
    ...
    .sort((a, b) => {
      ...
      return (b.reviews || 0) - (a.reviews || 0); // best-selling fallback
    });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-50">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://i.pinimg.com/1200x/c2/0b/71/c20b713c70ac40ff4779bad26ea2dc18.jpg)",
          ...
          <div className="container mx-auto px-6 lg:px-16">
            <div className="max-w-2xl text-white space-y-4">
              ...
              <p className="text-xl text-amber-100">
                Elegant Accents for Beautiful Outdoor Spaces
              </p>
              <p className="text-lg text-amber-200">
                Handcrafted Decorative Pieces for Gardens & Patios
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-6 lg:px-16 py-12">
        ...
        <div className="text-sm text-gray-600 mb-8">
          Home / Products /{" "}
          <span className="text-amber-700 font-medium">Garden Accessories</span>
        </div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full lg:w-auto">
                ...
                <div className="flex items-center gap-4 w-full sm:w-auto">
                  ...
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    <input
                      ...
                      className="w-32 sm:w-48 h-2 bg-amber-200 rounded-lg appearance-none cursor-pointer accent-amber-600"
                    />
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto">
                  ...
                  <select
                    ...
                    className="px-4 py-2 text-gray-800 font-medium border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 w-full sm:w-auto"
                  >
