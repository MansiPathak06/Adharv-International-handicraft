    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto mt-4 sm:mt-5 overflow-hidden px-3 sm:px-0">
        <div className="relative h-[200px] sm:h-[260px] md:h-[300px] overflow-hidden rounded-lg sm:rounded-none">
          <img
            src="https://i.pinimg.com/1200x/de/3b/24/de3b244acc123acf9f60ab0770b0dc1b.jpg"
            alt="Festive Collection"
            className="w-full h-full object-cover"
          />
          <div className="absolute top-6 sm:top-10 left-1/2 -translate-x-1/2 text-white text-center px-3">
            <h2
              className="text-2xl sm:text-3xl md:text-[42px] font-light mb-1.5 sm:mb-2.5 border-b-2 border-white inline-block pb-1 sm:pb-1.5"
              style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.5)' }}
            >
              New Launch
            </h2>
            <p
              className="text-sm sm:text-base md:text-lg mt-3 leading-relaxed"
              style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.5)' }}
            >
              Be the First to Shop <br className="hidden sm:block" />our premium Collection.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* CTA Banner 1 */}
      <div className="max-w-[1200px] mx-auto mt-10 sm:mt-14 mb-8 sm:mb-10 px-3 sm:px-0">
        <div
          className="relative rounded-2xl overflow-hidden h-40 sm:h-44 flex items-center group cursor-pointer bg-gradient-to-br from-[#f6d365] to-[#fda085]"
          onClick={() => router.push('/shopsbycollection')}
        >
          <img
            src="https://i.pinimg.com/1200x/1a/1b/86/1a1b86a0087bed6f0cba5d649ce50997.jpg"
            alt="Shop by Collection"
            className="absolute right-0 top-0 w-1/3 sm:w-1/4 h-full object-cover opacity-60 group-hover:opacity-80 transition-opacity duration-300"
          />
          <div className="relative z-10 pl-5 sm:pl-10 pr-28 sm:pr-40">
            <h2 className="text-xl sm:text-3xl font-bold text-gray-900 mb-1.5 sm:mb-2 group-hover:text-amber-800 transition-colors">
              Shop By Collection
            </h2>
            <p className="text-sm sm:text-lg text-gray-700 mb-2 sm:mb-3">
              Explore our curated collections for every festival and style.
            </p>
            <button className="px-6 sm:px-8 py-2.5 sm:py-3 bg-amber-700 text-white text-sm sm:text-base font-semibold rounded-lg shadow-md hover:bg-amber-800 transition">
              Browse Now
            </button>
          </div>
        </div>
